#!/bin/bash
	...
	echo ""
	echo "  g++ -g -std=c++17 lib/*.cpp vkmodules/Utils/*.cpp vkmodules/CellularAutomata/*.cpp vkmodules/UI/*.cpp vkmodules/Input/*.cpp vkmodules/VulkanFoundation/*.cpp vkmodules/CommandBuffer/*.cpp vkmodules/Resources/*.cpp vkmodules/Rendering/*.cpp vkmodules/Platform/*.cpp VulkanAutomataGLFW.cpp -fconcepts -lglfw -lvulkan -o ./app/RunVulkanAutomataGLFW"
