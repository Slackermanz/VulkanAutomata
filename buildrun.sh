#!/bin/bash
	...
	echo ""
	echo "  g++ -g -std=c++17 lib/*.cpp vkmodules/Utils/*.cpp vkmodules/CellularAutomata/*.cpp vkmodules/UI/*.cpp VulkanAutomataGLFW.cpp -fconcepts -lglfw -lvulkan -o ./app/RunVulkanAutomataGLFW"
			g++ -g -std=c++17 lib/*.cpp vkmodules/Utils/*.cpp vkmodules/CellularAutomata/*.cpp vkmodules/UI/*.cpp VulkanAutomataGLFW.cpp -fconcepts -lglfw -lvulkan -o ./app/RunVulkanAutomataGLFW
	echo ""
