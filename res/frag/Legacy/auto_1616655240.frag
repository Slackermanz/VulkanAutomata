...
//	----    ----    ----    ----    ----    ----    ----    ----
	...
	li = li * sign(eval4_ubi_f[14]);

//	Unterpolate
	float	unp_r = (res_r 	  	* 1.0 	+ res_g 	* -li 	+ res_b 	* -li	) / ( 1.0 - li * 2.0 );
	float	unp_g = (res_r 		* -li 	+ res_g 	* 1.0 	+ res_b 	* -li	) / ( 1.0 - li * 2.0 );
	float	unp_b = (res_r 		* -li	+ res_g 	* -li 	+ res_b 	* 1.0	) / ( 1.0 - li * 2.0 );
	res_r = unp_r;
	res_g = unp_g;
	res_b = unp_b;
/**/
