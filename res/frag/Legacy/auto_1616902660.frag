...
vec2 sub_ring(ivec2 nh, vec3[MAXSNH] rings){
	float e0_sum = 0.0;
	float e1_sum = 0.0;
	if(nh[0] == 0) { nh[0] = 1; }
	...
	return vec2(e0_sum, e1_sum); }

float sub_ring_avg(ivec2 nh, vec3[MAXSNH] rings){
	vec2 esum = sub_ring(nh, rings);
	return esum[0] / esum[1]; }

float sub_ring_total(ivec2 nh, vec3[MAXSNH] rings){
	vec2 esum = sub_ring(nh, rings);
	return esum[1]; }
...
//	Parameters
	float s  = 4.0;
	float b  = mnp * 16.0 *  1.0;
	float n  = mnp * 16.0 *   2.0;
	float p  = mnp * 16.0 *  64.0;

//	Get Neighbourhood Values
	float[SCNH_COUNT] nhv_r;
		nhv_r[0]  = sub_ring_avg(ivec2(SCUI00, SCUI01), rings_r);
		nhv_r[1]  = sub_ring_avg(ivec2(SCUI02, SCUI03), rings_r);
		nhv_r[2]  = sub_ring_avg(ivec2(SCUI04, SCUI05), rings_r);
		nhv_r[3]  = sub_ring_avg(ivec2(SCUI06, SCUI07), rings_r);
		nhv_r[4]  = sub_ring_avg(ivec2(SCUI08, SCUI09), rings_r);
		nhv_r[5]  = sub_ring_avg(ivec2(SCUI10, SCUI11), rings_r);
		nhv_r[6]  = sub_ring_avg(ivec2(SCUI12, SCUI13), rings_r);
		nhv_r[7]  = sub_ring_avg(ivec2(SCUI14, SCUI15), rings_r);
		nhv_r[8]  = sub_ring_avg(ivec2(SCUI16, SCUI17), rings_r);
		nhv_r[9]  = sub_ring_avg(ivec2(SCUI18, SCUI19), rings_r);
		nhv_r[10] = sub_ring_avg(ivec2(SCUI20, SCUI21), rings_r);
		nhv_r[11] = sub_ring_avg(ivec2(SCUI22, SCUI23), rings_r);
		nhv_r[12] = sub_ring_avg(ivec2(SCUI24, SCUI25), rings_r);
		nhv_r[13] = sub_ring_avg(ivec2(SCUI26, SCUI27), rings_r);
		nhv_r[14] = sub_ring_avg(ivec2(SCUI28, SCUI29), rings_r);
		nhv_r[15] = sub_ring_avg(ivec2(SCUI30, SCUI31), rings_r);
		nhv_r[16] = sub_ring_avg(ivec2(SCUI32, SCUI33), rings_r);
		nhv_r[17] = sub_ring_avg(ivec2(SCUI34, SCUI35), rings_r);
		nhv_r[18] = sub_ring_avg(ivec2(SCUI36, SCUI37), rings_r);
		nhv_r[19] = sub_ring_avg(ivec2(SCUI38, SCUI39), rings_r);
		nhv_r[20] = sub_ring_avg(ivec2(SCUI40, SCUI41), rings_r);
		nhv_r[21] = sub_ring_avg(ivec2(SCUI42, SCUI43), rings_r);
		nhv_r[22] = sub_ring_avg(ivec2(SCUI44, SCUI46), rings_r);
		nhv_r[23] = sub_ring_avg(ivec2(SCUI46, SCUI47), rings_r);

//	NH Total Cell Counts
	float[SCNH_COUNT] nht_r;
		nht_r[0]  = sub_ring_total(ivec2(SCUI00, SCUI01), rings_r);
		nht_r[1]  = sub_ring_total(ivec2(SCUI02, SCUI03), rings_r);
		nht_r[2]  = sub_ring_total(ivec2(SCUI04, SCUI05), rings_r);
		nht_r[3]  = sub_ring_total(ivec2(SCUI06, SCUI07), rings_r);
		nht_r[4]  = sub_ring_total(ivec2(SCUI08, SCUI09), rings_r);
		nht_r[5]  = sub_ring_total(ivec2(SCUI10, SCUI11), rings_r);
		nht_r[6]  = sub_ring_total(ivec2(SCUI12, SCUI13), rings_r);
		nht_r[7]  = sub_ring_total(ivec2(SCUI14, SCUI15), rings_r);
		nht_r[8]  = sub_ring_total(ivec2(SCUI16, SCUI17), rings_r);
		nht_r[9]  = sub_ring_total(ivec2(SCUI18, SCUI19), rings_r);
		nht_r[10] = sub_ring_total(ivec2(SCUI20, SCUI21), rings_r);
		nht_r[11] = sub_ring_total(ivec2(SCUI22, SCUI23), rings_r);
		nht_r[12] = sub_ring_total(ivec2(SCUI24, SCUI25), rings_r);
		nht_r[13] = sub_ring_total(ivec2(SCUI26, SCUI27), rings_r);
		nht_r[14] = sub_ring_total(ivec2(SCUI28, SCUI29), rings_r);
		nht_r[15] = sub_ring_total(ivec2(SCUI30, SCUI31), rings_r);
		nht_r[16] = sub_ring_total(ivec2(SCUI32, SCUI33), rings_r);
		nht_r[17] = sub_ring_total(ivec2(SCUI34, SCUI35), rings_r);
		nht_r[18] = sub_ring_total(ivec2(SCUI36, SCUI37), rings_r);
		nht_r[19] = sub_ring_total(ivec2(SCUI38, SCUI39), rings_r);
		nht_r[20] = sub_ring_total(ivec2(SCUI40, SCUI41), rings_r);
		nht_r[21] = sub_ring_total(ivec2(SCUI42, SCUI43), rings_r);
		nht_r[22] = sub_ring_total(ivec2(SCUI44, SCUI46), rings_r);
		nht_r[23] = sub_ring_total(ivec2(SCUI46, SCUI47), rings_r);
...
//	----    ----    ----    ----    ----    ----    ----    ----
	...
	for(int i = 0; i < 2; i++) {
		...
		if(nhv_r[i] >= eval4_f[i*8+0] && nhv_r[i] <= eval4_f[i*8+1]) { res_r_0 = res_r_0 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+2] && nhv_r[i] <= eval4_f[i*8+3]) { res_r_0 = res_r_0 - s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+4] && nhv_r[i] <= eval4_f[i*8+5]) { res_r_0 = res_r_0 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+6] && nhv_r[i] <= eval4_f[i*8+7]) { res_r_0 = res_r_0 - s / sqrt(nht_r[i]); } }
	res_r_0 = (res_r_0 + blr_r_0) / (1.0 + b * 2.0);

	for(int i = 2; i < 4; i++) {
		blr_r_1 = blr_r_1 + nhv_r[i] * b;
		if(nhv_r[i] >= eval4_f[i*8+0] && nhv_r[i] <= eval4_f[i*8+1]) { res_r_1 = res_r_1 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+2] && nhv_r[i] <= eval4_f[i*8+3]) { res_r_1 = res_r_1 - s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+4] && nhv_r[i] <= eval4_f[i*8+5]) { res_r_1 = res_r_1 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+6] && nhv_r[i] <= eval4_f[i*8+7]) { res_r_1 = res_r_1 - s / sqrt(nht_r[i]); } }
	res_r_1 = (res_r_1 + blr_r_1) / (1.0 + b * 2.0);

	for(int i = 4; i < 6; i++) {
		blr_r_2 = blr_r_2 + nhv_r[i] * b;
		if(nhv_r[i] >= eval4_f[i*8+0] && nhv_r[i] <= eval4_f[i*8+1]) { res_r_2 = res_r_2 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+2] && nhv_r[i] <= eval4_f[i*8+3]) { res_r_2 = res_r_2 - s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+4] && nhv_r[i] <= eval4_f[i*8+5]) { res_r_2 = res_r_2 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+6] && nhv_r[i] <= eval4_f[i*8+7]) { res_r_2 = res_r_2 - s / sqrt(nht_r[i]); } }
	res_r_2 = (res_r_2 + blr_r_2) / (1.0 + b * 2.0);

	for(int i = 6; i < 8; i++) {
		blr_r_3 = blr_r_3 + nhv_r[i] * b;
		if(nhv_r[i] >= eval4_f[i*8+0] && nhv_r[i] <= eval4_f[i*8+1]) { res_r_3 = res_r_3 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+2] && nhv_r[i] <= eval4_f[i*8+3]) { res_r_3 = res_r_3 - s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+4] && nhv_r[i] <= eval4_f[i*8+5]) { res_r_3 = res_r_3 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+6] && nhv_r[i] <= eval4_f[i*8+7]) { res_r_3 = res_r_3 - s / sqrt(nht_r[i]); } }
	res_r_3 = (res_r_3 + blr_r_3) / (1.0 + b * 2.0);

	for(int i = 8; i < 10; i++) {
		blr_r_4 = blr_r_4 + nhv_r[i] * b;
		if(nhv_r[i] >= eval4_f[i*8+0] && nhv_r[i] <= eval4_f[i*8+1]) { res_r_4 = res_r_4 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+2] && nhv_r[i] <= eval4_f[i*8+3]) { res_r_4 = res_r_4 - s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+4] && nhv_r[i] <= eval4_f[i*8+5]) { res_r_4 = res_r_4 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+6] && nhv_r[i] <= eval4_f[i*8+7]) { res_r_4 = res_r_4 - s / sqrt(nht_r[i]); } }
	res_r_4 = (res_r_4 + blr_r_4) / (1.0 + b * 2.0);

	for(int i = 10; i < 12; i++) {
		blr_r_5 = blr_r_5 + nhv_r[i] * b;
		if(nhv_r[i] >= eval4_f[i*8+0] && nhv_r[i] <= eval4_f[i*8+1]) { res_r_5 = res_r_5 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+2] && nhv_r[i] <= eval4_f[i*8+3]) { res_r_5 = res_r_5 - s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+4] && nhv_r[i] <= eval4_f[i*8+5]) { res_r_5 = res_r_5 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+6] && nhv_r[i] <= eval4_f[i*8+7]) { res_r_5 = res_r_5 - s / sqrt(nht_r[i]); } }
	res_r_5 = (res_r_5 + blr_r_5) / (1.0 + b * 2.0);

	for(int i = 12; i < 14; i++) {
		blr_r_6 = blr_r_6 + nhv_r[i] * b;
		if(nhv_r[i] >= eval4_f[i*8+0] && nhv_r[i] <= eval4_f[i*8+1]) { res_r_6 = res_r_6 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+2] && nhv_r[i] <= eval4_f[i*8+3]) { res_r_6 = res_r_6 - s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+4] && nhv_r[i] <= eval4_f[i*8+5]) { res_r_6 = res_r_6 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+6] && nhv_r[i] <= eval4_f[i*8+7]) { res_r_6 = res_r_6 - s / sqrt(nht_r[i]); } }
	res_r_6 = (res_r_6 + blr_r_6) / (1.0 + b * 2.0);

	for(int i = 14; i < 16; i++) {
		blr_r_7 = blr_r_7 + nhv_r[i] * b;
		if(nhv_r[i] >= eval4_f[i*8+0] && nhv_r[i] <= eval4_f[i*8+1]) { res_r_7 = res_r_7 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+2] && nhv_r[i] <= eval4_f[i*8+3]) { res_r_7 = res_r_7 - s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+4] && nhv_r[i] <= eval4_f[i*8+5]) { res_r_7 = res_r_7 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+6] && nhv_r[i] <= eval4_f[i*8+7]) { res_r_7 = res_r_7 - s / sqrt(nht_r[i]); } }
	res_r_7 = (res_r_7 + blr_r_7) / (1.0 + b * 2.0);

	for(int i = 16; i < 18; i++) {
		blr_r_8 = blr_r_8 + nhv_r[i] * b;
		if(nhv_r[i] >= eval4_f[i*8+0] && nhv_r[i] <= eval4_f[i*8+1]) { res_r_8 = res_r_8 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+2] && nhv_r[i] <= eval4_f[i*8+3]) { res_r_8 = res_r_8 - s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+4] && nhv_r[i] <= eval4_f[i*8+5]) { res_r_8 = res_r_8 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+6] && nhv_r[i] <= eval4_f[i*8+7]) { res_r_8 = res_r_8 - s / sqrt(nht_r[i]); } }
	res_r_8 = (res_r_8 + blr_r_8) / (1.0 + b * 2.0);

	for(int i = 18; i < 20; i++) {
		blr_r_9 = blr_r_9 + nhv_r[i] * b;
		if(nhv_r[i] >= eval4_f[i*8+0] && nhv_r[i] <= eval4_f[i*8+1]) { res_r_9 = res_r_9 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+2] && nhv_r[i] <= eval4_f[i*8+3]) { res_r_9 = res_r_9 - s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+4] && nhv_r[i] <= eval4_f[i*8+5]) { res_r_9 = res_r_9 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+6] && nhv_r[i] <= eval4_f[i*8+7]) { res_r_9 = res_r_9 - s / sqrt(nht_r[i]); } }
	res_r_9 = (res_r_9 + blr_r_9) / (1.0 + b * 2.0);

	for(int i = 20; i < 22; i++) {
		blr_r_10 = blr_r_10 + nhv_r[i] * b;
		if(nhv_r[i] >= eval4_f[i*8+0] && nhv_r[i] <= eval4_f[i*8+1]) { res_r_10 = res_r_10 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+2] && nhv_r[i] <= eval4_f[i*8+3]) { res_r_10 = res_r_10 - s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+4] && nhv_r[i] <= eval4_f[i*8+5]) { res_r_10 = res_r_10 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+6] && nhv_r[i] <= eval4_f[i*8+7]) { res_r_10 = res_r_10 - s / sqrt(nht_r[i]); } }
	res_r_10 = (res_r_10 + blr_r_10) / (1.0 + b * 2.0);

	for(int i = 22; i < 24; i++) {
		blr_r_11 = blr_r_11 + nhv_r[i] * b;
		if(nhv_r[i] >= eval4_f[i*8+0] && nhv_r[i] <= eval4_f[i*8+1]) { res_r_11 = res_r_11 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+2] && nhv_r[i] <= eval4_f[i*8+3]) { res_r_11 = res_r_11 - s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+4] && nhv_r[i] <= eval4_f[i*8+5]) { res_r_11 = res_r_11 + s / sqrt(nht_r[i]); }
		if(nhv_r[i] >= eval4_f[i*8+6] && nhv_r[i] <= eval4_f[i*8+7]) { res_r_11 = res_r_11 - s / sqrt(nht_r[i]); } }
